...
final class HomeViewController: UIViewController {
  ...
  @objc private func listDashImageTapped() {
    //mainViewModel.goToProfile()
    delegate?.didMenuButtonTapped()
  }
...
private extension HomeViewController {
  ...
  func setupNavigationBar() {
    ...
    let listDashImage = UIBarButtonItem(image: UIImage(systemName: "list.dash"), style: .plain, target: self, action: #selector(listDashImageTapped))
    navigationController?.topViewController?.navigationItem.leftBarButtonItem = listDashImage
    listDashImage.tintColor = .red
  }
}
